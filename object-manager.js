(function () {
  ...
  function validateFeature(index) {
    ...
    if (!normalizeText(properties.Donor)) warnings.push('Donor/pendana belum diklasifikasikan.');
    if (!normalizeText(properties.Program)) warnings.push('Program/proyek belum diisi.');
    if (!normalizeText(properties.Jenis_Kegiatan)) warnings.push('Jenis kegiatan belum diklasifikasikan.');
  ...
  function openObject(index) {
    ...
    [
      ...
      'Jumlah_Tanam', 'Panjang_M', 'Program', 'Donor', 'Mitra',
      'Jenis_Kegiatan', 'Tema_Program', 'Fase', 'Tanggal_Mulai',
      'Tanggal_Selesai', 'Penerima_Manfaat', 'Kelompok_Sasaran',
      'SDGs', 'Sumber_Data', 'Ket'
  ...
  function applyFormToObject() {
    ...
    [
      'Object_ID', 'Nama_Objek', 'Kategori', 'Status_Objek',
      'Kabupaten', 'Kecamatan', 'Desa', 'Tahun', 'Program', 'Donor',
      'Mitra', 'Jenis_Kegiatan', 'Tema_Program', 'Fase', 'Tanggal_Mulai',
      'Tanggal_Selesai', 'Kelompok_Sasaran', 'SDGs', 'Sumber_Data', 'Ket'
    ].forEach(function (key) {
      properties[key] = form.elements[key].value.trim();
    });

    ['Luas_Ha', 'Jumlah_Tanam', 'Panjang_M', 'Penerima_Manfaat'].forEach(function (key) {
